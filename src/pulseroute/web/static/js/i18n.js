(() => {
    const pairs = [
        ...
        ['Sliding-window rate limits protect the service from automated abuse. Repeated failed sign-ins trigger a 10-minute IP lockout. Abuse reports about phishing or malware can quarantine a link immediately. Other report types are counted once per reporter signal during the fixed 24-hour deduplication window; 5 distinct reports can quarantine a link and 10 can disable it. A disabled link record remains available for moderation and an owner appeal; it is not immediately erased from the database.', 'Kayan pencere hız sınırları hizmeti otomatik kötüye kullanıma karşı korur. Tekrarlanan başarısız giriş denemeleri IP adresini 10 dakika engeller. Oltalama veya zararlı yazılım bildirimleri bağlantıyı hemen karantinaya alabilir. Diğer bildirim türleri sabit 24 saatlik tekilleştirme süresinde bildirim sinyali başına bir kez sayılır; 5 farklı bildirim bağlantıyı karantinaya alabilir, 10 bildirim ise devre dışı bırakabilir. Devre dışı bırakılan bağlantı kaydı moderasyon ve sahibi tarafından yapılabilecek itiraz için korunur; hemen veritabanından silinmez.'],
        ['Reports submitted through the form are recorded in the service database; the form does not email the operator. Human review or a response within a specific timeframe is not guaranteed. Automated actions may be taken without prior human review. Accounts and workspaces found to repeatedly violate these terms may be closed.', 'Form üzerinden gönderilen bildirimler hizmet veritabanına kaydedilir; form işletmeciye e-posta göndermez. İnsan incelemesi veya belirli bir sürede yanıt garanti edilmez. Otomatik işlemler insan incelemesi olmadan uygulanabilir. Şartları tekrarlı biçimde ihlal ettiği belirlenen hesaplar ve çalışma alanları kapatılabilir.'],
        ...
        ['When you submit a report through the', 'Şu kanal üzerinden bildirim gönderdiğinizde:'], ['or API, the service processes the submitted link, reason, details, reporter email, and a masked IP to record the report, apply automated safety controls, and prevent misuse of the reporting channel.', 'veya API aracılığıyla hizmet; bildirimi kaydetmek, otomatik güvenlik kontrollerini uygulamak ve bildirim kanalının kötüye kullanımını önlemek için gönderilen bağlantıyı, nedeni, açıklamayı, bildirim sahibinin e-posta adresini ve maskelenmiş IP adresini işler.'],
        ['The online form does not email the instance operator. Reports may be retained as required to meet legal obligations under Law No. 5651 and applicable data protection law.', 'Çevrimiçi form işletmeciye e-posta göndermez. Bildirimler, 5651 sayılı Kanun ve geçerli veri koruma mevzuatından doğan yükümlülükler için gerektiği süre boyunca saklanabilir.'],
        ...
        ['Abuse report | PulseRoute', 'Kötüye kullanım bildirimi | PulseRoute'], ['Report phishing, malware, and other security issues involving PulseRoute short links.', 'PulseRoute kısa bağlantıları için oltalama, zararlı yazılım ve diğer güvenlik ihlallerini bildirin.'],
        ['Skip to main content', 'Ana içeriğe geç'], ['PulseRoute home', 'PulseRoute ana sayfa'], ['Main navigation', 'Ana gezinme'], ['Terms', 'Kullanım şartları'], ['Privacy', 'Gizlilik'],
        ['Report information', 'Bildirim bilgisi'], ['SECURITY · REPORT', 'GÜVENLİK · BİLDİRİM'], ['Report a suspicious link.', 'Şüpheli bağlantıyı bize iletin.'],
        ['Use this form to report phishing, malware, copyright infringement, or another security issue at a destination reached through a PulseRoute short link.', 'PulseRoute kısa bağlantısıyla yönlendirilen bir hedefte oltalama, zararlı yazılım, telif ihlali veya başka bir güvenlik sorunu gördüyseniz formu doldurun.'],
        ['Phishing and malware', 'Oltalama ve zararlı yazılım'], ['reports may quarantine a link immediately. Other reports enter the review queue and the system may quarantine or remove a link when needed.', 'bildirimleri bağlantıyı hemen karantinaya alabilir. Diğer bildirimler inceleme kuyruğuna alınır; sistem gerektiğinde bağlantıyı otomatik karantinaya alabilir veya kaldırabilir.'],
        ['LAW NO. 5651 · NOTICE AND TAKEDOWN', '5651 · UYAR-KALDIR'], ['Abuse report', 'Kötüye kullanım bildirimi'], ['Provide the link and issue type to record your report.', 'Bağlantıyı ve ihlal türünü bildirimin kaydedilmesi için belirtin.'], ['SECURITY REPORT', 'GÜVENLİK BİLDİRİMİ'],
        ['Your email address is included in the report record; no automatic email is sent.', 'E-posta adresiniz bildirim kaydına eklenir; otomatik e-posta gönderilmez.'],
        ['Short link or code', 'Kısa bağlantı veya kod'], ['ps.sely.tr/example-code or example-code', 'ps.sely.tr/ornek-kod veya ornek-kod'], ['Paste the PulseRoute link you are reporting.', 'Bildirilecek PulseRoute bağlantısını yapıştırın.'],
        ['Issue type', 'İhlal türü'], ['Select a category', 'Bir kategori seçin'], ['Phishing or fake sign-in page', 'Oltalama veya sahte giriş sayfası'], ['Malware or dangerous file', 'Zararlı yazılım veya tehlikeli dosya'], ['Unlawful content', 'Yasa dışı içerik'], ['Copyright or trademark infringement', 'Telif hakkı veya marka ihlali'], ['Unsolicited bulk messages / spam', 'İstenmeyen toplu ileti / spam'], ['Other security issue', 'Diğer güvenlik ihlali'],
        ['Phishing and malware reports can quarantine a link immediately.', 'Oltalama ve zararlı yazılım bildirimleri bağlantıyı hemen karantinaya alabilir.'], ['Your contact email', 'İletişim e-posta adresiniz'], ['security@your-organization.com', 'guvenlik@kurumunuz.com'],
        ['Details or evidence', 'Açıklama veya delil'], ['Optional', 'İsteğe bağlı'], ['Describe the issue you observed and include relevant details.', 'Gördüğünüz sorunu ve varsa ilgili ayrıntıları açıklayın.'], ['Do not include passwords, payment details, or other sensitive personal data.', 'Parola, ödeme bilgisi veya başka hassas kişisel veri eklemeyin.'],
        ['Submit security report', 'Güvenlik bildirimini gönder'], ['Hosting provider notice', 'Yer sağlayıcı bildirimi'], ['· Notices about unlawful content are assessed under Law No. 5651 and applicable duties. Automated thresholds do not verify a person and are not, by themselves, a final legal determination that a link is unlawful.', '· Hukuka aykırı içerik bildirimleri 5651 sayılı Kanun ve geçerli yükümlülükler kapsamında değerlendirilir. Otomatik eşikler kişi doğrulaması değildir; bir bağlantının karantinaya alınması veya silinmesi için tek başına kesin hukuki karar sayılmaz.'],
        ['Operator contact', 'Yetkili iletişim'], ['Select to email or copy the address', 'E-posta göndermek veya adresi kopyalamak için seçin'], ['← Terms', '← Kullanım şartları'], ['Privacy notice', 'Gizlilik bildirimi'], ['Back to PulseRoute', 'PulseRoute’a dön'],
        ['This report was already received', 'Bu bildirim daha önce alınmış'], ['Your report has been recorded', 'Bildiriminiz kaydedildi'], ['Could not submit report', 'Bildirim gönderilemedi'], ['Could not reach the server', 'Sunucuya ulaşılamadı'], ['Submitting…', 'Gönderiliyor…'],
        ['Check the link and details, then try again.', 'Bağlantıyı ve girdiğiniz bilgileri kontrol edip tekrar deneyin.'], ['Check your connection and try again later.', 'Lütfen bağlantınızı kontrol edip daha sonra tekrar deneyin.'],
        ['A report with the same signal for this link was recently received.', 'Bu bağlantı için aynı sinyalden yakın zamanda bildirim alındı.'],
        ...
        ['Security notice — Link suspended | PulseRoute', 'Güvenlik Uyarısı — Bağlantı Askıya Alındı | PulseRoute'], ['HTTP 451 • ACCESS BLOCKED', 'HTTP 451 • ERİŞİM ENGELLENDİ'], ['Security notice: Link quarantined', 'Güvenlik Uyarısı: Bağlantı Karantinaya Alındı'], ['The short link you tried to open was suspended because of a suspected violation involving', 'Ulaşmaya çalıştığınız kısa bağlantı;'], ['Turkish Law No. 5651', '5651 Sayılı Kanun'], ['Phishing', 'Oltalama (Phishing)'], ['Malware', 'Zararlı Yazılım (Malware)'], ['or', 'veya'], ['our acceptable-use policy', 'Kötüye Kullanım İlkelerimizin'], ['and redirects to its destination have been stopped.', 'ihlali şüphesiyle sistemimiz tarafından derhal askıya alınmış ve hedef sayfaya yönlendirme durdurulmuştur.'], ['Access status:', 'Erişim Durumu:'], ['Suspended (quarantined)', 'Askıya Alındı (Quarantined)'], ['Legal / security basis:', 'Yasal / Güvenlik Dayanağı:'], ['Law No. 5651 and applicable notice-and-takedown rules', '5651 Sayılı Kanun & Safe Harbor Uyar-Kaldır'], ['Security note:', 'Güvenlik Notu:'], ['For your safety, do not visit the original address or share personal or financial information there.', 'Güvenliğiniz için bu bağlantının yönlendirmeye çalıştığı orijinal adresi ziyaret etmeyiniz ve kişisel veya finansal bilgilerinizi kesinlikle paylaşmayınız.'], ['Report abuse', 'Kötüye Kullanım Bildir'], ['Terms of service & security policy →', 'Hizmet Şartları & Güvenlik Politikası →'], ['PulseRoute edge security • hosting provider safety mechanism under Law No. 5651', 'PulseRoute Edge Security • 5651 Sayılı Kanun Uyarınca Yer Sağlayıcı Güvenlik Mekanizması'],
        ...
        ['The online form records a report in the service database and does not email the operator. This service does not promise a human review, an immediate response, or a particular outcome for every report. Automated risk signals may block or quarantine a link without prior human review; they can miss harmful material or flag a link incorrectly. This does not limit any action required by applicable law.', 'Çevrimiçi form bildirimi hizmet veritabanına kaydeder ve işletmeciye e-posta göndermez. Bu hizmet insan incelemesi, anında yanıt veya her bildirim için belirli bir sonuç vaat etmez. Otomatik risk sinyalleri önceden insan incelemesi olmadan bağlantıyı engelleyebilir veya karantinaya alabilir; zararlı içeriği gözden kaçırabilir ya da bağlantıyı yanlış işaretleyebilir. Bu durum, geçerli mevzuatın gerektirdiği işlemleri sınırlamaz.'],
        ['The service does not continuously monitor every third-party destination. A report submission does not guarantee human review, an immediate response, or a particular decision. Applicable legal duties and valid notices or orders continue to apply. Automated controls may quarantine a link without prior human review.', 'Hizmet, üçüncü taraf hedeflerin tamamını sürekli izlemez. Bildirim göndermek insan incelemesi, anında yanıt veya belirli bir karar garantisi vermez. Geçerli yasal yükümlülükler ile usulüne uygun bildirim ve kararlar geçerliliğini korur. Otomatik kontroller, önceden insan incelemesi olmadan bir bağlantıyı karantinaya alabilir.'],
    ...
    const supplementalPairs = [
        ['SAFETY DESK', 'GÜVENLİK MERKEZİ'], ['REPORT', 'BİLDİRİM'], ['Found a suspicious link?', 'Şüpheli bir bağlantı mı buldunuz?'],
        ['Tell us if a page reached through a PulseRoute short link contains phishing, malware, copyright infringement, or another security issue.', 'PulseRoute kısa bağlantısıyla ulaşılan bir sayfada oltalama, zararlı yazılım, telif ihlali veya başka bir güvenlik sorunu varsa bize bildirin.'],
        ['What happens after you report?', 'Bildiriminiz nasıl işlenir?'], ['These reports can quarantine a link immediately.', 'Bu bildirimler bağlantıyı hemen karantinaya alabilir.'],
        ['Other issue types', 'Diğer ihlal türleri'], ['The system may assess security signals and reports and automatically quarantine or remove a link when needed.', 'Sistem güvenlik sinyallerini ve bildirimleri değerlendirip gerekirse bağlantıyı otomatik karantinaya alabilir veya kaldırabilir.'],
        ['Your report is recorded in the system.', 'Bildiriminiz sisteme kaydedilir.'], ['Human review or a response within a specific timeframe is not guaranteed; the system may automatically quarantine or remove some links.', 'İnsan incelemesi veya belirli bir sürede yanıt garanti edilmez; sistem bazı bağlantıları otomatik olarak karantinaya alabilir ya da kaldırabilir.'],
        ['SECURITY REPORT', 'GÜVENLİK BİLDİRİMİ'], ['Report form', 'Bildirim formu'], ['Provide the link and issue type to record your report.', 'Bağlantıyı ve ihlal türünü bildirimin kaydedilmesi için belirtin.'],
        ['Your email address is included in the report record; no automatic email is sent.', 'E-posta adresiniz bildirim kaydına eklenir; otomatik e-posta gönderilmez.'],
        ['Phishing and malware reports can quarantine a link immediately.', 'Oltalama ve zararlı yazılım bildirimleri bağlantıyı hemen karantinaya alabilir.'],
        ['How reports work and legal context', 'İşleyiş ve yasal çerçeve'], ['Hosting provider notice.', 'Yer sağlayıcı bildirimi.'],
        ['Article 5 of Law No. 5651 does not require a hosting provider to continuously monitor content or investigate its unlawfulness. Duties under the law in response to valid notices and decisions remain applicable.', '5651 sayılı Kanun’un 5. maddesi yer sağlayıcı için içerikleri sürekli izleme veya hukuka aykırılığı araştırma yükümlülüğü öngörmez. Kanundaki geçerli bildirim ve kararlar üzerine doğan yükümlülükler saklıdır.'],
        ['Automated security signals may quarantine a link. Harmful content may be missed, or a link may be flagged by mistake. Automated thresholds do not verify a reporter’s identity and are not, by themselves, a final legal determination. A report does not replace required legal processes.', 'Otomatik güvenlik sinyalleri karantina uygulayabilir. Zararlı içerik gözden kaçabilir veya bağlantı yanlış işaretlenebilir. Otomatik eşikler bildirim yapan kişinin kimliğini doğrulamaz ve tek başına kesin hukuki karar sayılmaz. Bildirim, zorunlu hukuki süreçlerin yerine geçmez.'],
        ['Your report has been recorded. Human review or a response within a specific timeframe is not guaranteed.', 'Bildiriminiz sisteme kaydedildi. İnsan incelemesi veya belirli bir sürede yanıt garanti edilmez.'],
        ...
        ['Owner access', 'Sahip erişimi'], ['TRUST & SAFETY', 'GÜVEN VE GÜVENLİK'], ['Review with care.', 'Dikkatle inceleyin.'], ['A private workspace for reports, link restrictions and owner appeals.', 'Bildirimler, bağlantı kısıtlamaları ve sahip itirazları için özel çalışma alanı.'], ['Owner email', 'Sahip e-postası'], ['Open safety desk', 'Güvenlik panelini aç'], ['Short-lived secure session · 30 minutes', 'Kısa süreli güvenli oturum · 30 dakika'], ['INBOX', 'GELEN KUTUSU'], ['Review queue', 'İnceleme kuyruğu'], ['Reports', 'Bildirimler'], ['Restricted', 'Kısıtlananlar'], ['Appeals', 'İtirazlar'], ['Load older', 'Daha eskileri yükle'], ['Choose an item to inspect', 'İncelemek için bir kayıt seçin'], ['Review its context before taking action.', 'İşlem yapmadan önce bağlamını inceleyin.'], ['Owner moderation', 'Sahip moderasyonu'], ['Every decision is recorded with its timestamp.', 'Her karar zaman damgasıyla kaydedilir.'], ['Appeal link restriction', 'Bağlantı kısıtlamasına itiraz et'], ['Explain why this link should be restored. The owner team will review the request when available.', 'Bu bağlantının neden yeniden açılması gerektiğini açıklayın. Talep, müsait olduğumuzda incelenir.'], ['Submit appeal', 'İtiraz gönder'], ['Appeal', 'İtiraz et'], ['Appeal submitted for review.', 'İtiraz inceleme için gönderildi.'], ['Could not submit appeal.', 'İtiraz gönderilemedi.'],
        ['Open reports and appeals are deleted 180 days after submission if they remain unresolved. Closed report and appeal records are deleted 180 days after resolution, subject to applicable legal obligations.', 'Çözülmemiş açık bildirim ve itirazlar gönderimden 180 gün sonra silinir. Kapanan bildirim ve itiraz kayıtları, geçerli yasal yükümlülükler saklı kalmak üzere, karar tarihinden 180 gün sonra silinir.'],
        ['used for matching during a fixed 24-hour window, then cleared during the daily retention pass.', 'sabit 24 saatlik eşleştirme penceresinde kullanılır ve günlük saklama temizliğinde kaldırılır.'],
        ['Five distinct reports can quarantine a link; phishing or malware reports may quarantine immediately. Ten distinct reports can disable it while preserving its moderation and appeal history. Closed report and appeal records are deleted 180 days after resolution, subject to applicable legal obligations.', '5 farklı bildirim bağlantıyı karantinaya alabilir; oltalama veya zararlı yazılım bildirimleri anında karantinaya yol açabilir. 10 farklı bildirim, moderasyon ve itiraz geçmişi korunarak bağlantıyı devre dışı bırakabilir. Kapanan bildirim ve itiraz kayıtları, geçerli yasal yükümlülükler saklı kalmak üzere, karar tarihinden 180 gün sonra silinir.'],
        ['The online form does not email the instance operator. Open reports and appeals are deleted 180 days after submission if they remain unresolved. Closed report and appeal records are deleted 180 days after resolution, subject to applicable legal obligations.', 'Çevrimiçi form işletmeciye e-posta göndermez. Çözülmemiş açık bildirim ve itirazlar gönderimden 180 gün sonra silinir. Kapanan bildirim ve itiraz kayıtları, geçerli yasal yükümlülükler saklı kalmak üzere, karar tarihinden 180 gün sonra silinir.'],
        ['To prevent repeated submissions from automatically affecting a link, the service derives a keyed HMAC-SHA-256 digest from the request IP, user-agent, and language headers. The raw values used for this matching digest are not stored by this feature. The digest is pseudonymous personal data, not anonymous data: it is used for matching during a fixed 24-hour window, then cleared during the daily retention pass. The digest is not used for advertising or cross-site tracking.', 'Tekrarlanan bildirimlerin bir bağlantıyı otomatik olarak etkilemesini önlemek için hizmet, isteğin IP adresi, user-agent ve dil başlıklarından anahtarlı HMAC-SHA-256 özeti üretir. Eşleştirme için kullanılan ham değerler bu özellik kapsamında saklanmaz. Özet anonim değil, takma adlı kişisel veridir: sabit 24 saatlik eşleştirme penceresinde kullanılır ve günlük saklama temizliğinde kaldırılır. Özet reklam veya siteler arası izleme için kullanılmaz.'],
        ['Five distinct reports can quarantine a link; phishing or malware reports may quarantine immediately. Ten distinct reports can disable it while preserving its moderation and appeal history. Open cases are removed after 180 days if unresolved; closed report and appeal records are deleted 180 days after resolution, subject to applicable legal obligations. Automated signals can miss harmful material or flag a link incorrectly. See', '5 farklı bildirim bağlantıyı karantinaya alabilir; oltalama veya zararlı yazılım bildirimleri anında karantinaya yol açabilir. 10 farklı bildirim, moderasyon ve itiraz geçmişi korunarak bağlantıyı devre dışı bırakabilir. Çözülmemiş açık dosyalar 180 gün sonra silinir; kapanan bildirim ve itiraz kayıtları, geçerli yasal yükümlülükler saklı kalmak üzere, karar tarihinden 180 gün sonra silinir. Otomatik sinyaller zararlı içeriği gözden kaçırabilir veya bir bağlantıyı yanlış işaretleyebilir. Ayrıntılar için'],
        ['Decision history', 'Karar geçmişi'], ['Masked IP', 'Maskelenmiş IP'],
    ];
